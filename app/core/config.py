...
class Settings(BaseSettings):
    ...
    vad_end_pause_sec: float = 0.7         # пауза после обычной речи (сек)
    vad_end_pause_short_sec: float = 1.2   # пауза после короткой реплики (сек)
    ...
    no_input_timeout_sec: float = 10.0
